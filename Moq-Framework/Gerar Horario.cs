...
public class GerarHorario
{
    ...
    private readonly IGerarHorario _minhaInterface;//ATRIBUTO ONDE FICARA SALVO OS OBJETOS MOCKADOS


    public GerarHorario(IGerarHorario minhaInterface)//QUANDO E FEITO A INSTANCIA DEVE-SE PASSAR OBRIGATORIAMENTE OS OBJETOS MOCKADOS COMO PARAMETRO
    {
        _minhaInterface = minhaInterface;
    }
